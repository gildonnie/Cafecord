    ...
    return (
        <div className="prodBackground">
            ...
            <div className="products">
                ...
                <img src="../src/assets/toGoPacks.png"></img>
                <h2>COFFEE To Go</h2>
